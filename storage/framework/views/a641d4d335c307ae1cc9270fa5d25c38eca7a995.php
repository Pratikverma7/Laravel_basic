...
<body>
	<div class="container-fluid">
		<div class="container col-lg-8 m-auto d-block bg-light">
			<form  method ="POST" action="<?php echo e(url('teacher/insert')); ?>">
	        <?php echo csrf_field(); ?>
	       <label>Name : </label>
	      ...
	      <select name="branch" class="form-control">
	       ...
	       <br>
	       <label>Phone : </label>
	       <input type="text" name="phone" placeholder="address" class="form-control">
	       <br>
	       <br><label>Email: </label>
	       <input type="text" name="email" placeholder="address" class="form-control">
	       <br>
	       <br>
	       <label>Gender : </label>
...
</html><?php /**PATH C:\Users\pratik verma\Desktop\laravel fresh\laravel_basic\resources\views/teacher/form.blade.php ENDPATH**/ ?>